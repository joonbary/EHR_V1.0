        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "incentive_rate",
                    models.DecimalField(
                        decimal_places=1, max_digits=5, verbose_name="지급률 (%)"
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "allowance_amount",
                    models.DecimalField(
                        decimal_places=0, max_digits=10, verbose_name="직책급 (원)"
                    ),
                ),
                ("created_at", models.DateTimeField(auto_now_add=True)),
                ("updated_at", models.DateTimeField(auto_now=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "competency_pay",
                    models.DecimalField(
                        decimal_places=0, max_digits=10, verbose_name="역량급 (원)"
                    ),
                ),
                ("created_at", models.DateTimeField(auto_now_add=True)),
                ("updated_at", models.DateTimeField(auto_now=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "base_salary",
                    models.DecimalField(
                        decimal_places=0, max_digits=10, verbose_name="기본급 (원)"
                    ),
                ),
                ("created_at", models.DateTimeField(auto_now_add=True)),
                ("updated_at", models.DateTimeField(auto_now=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "fixed_overtime",
                    models.DecimalField(
                        decimal_places=0, max_digits=10, verbose_name="고정OT (원)"
                    ),
                ),
                (
                    "competency_pay",
                ...
                (
                    "pi_amount",
                    models.DecimalField(
                        decimal_places=0, max_digits=10, verbose_name="성과급 (원)"
                    ),
                ),
                (
                    "total_compensation",
                    models.DecimalField(
                        decimal_places=0, max_digits=12, verbose_name="총 보상 (원)"
                    ),
                ),
                ("created_at", models.DateTimeField(auto_now_add=True)),
                ("updated_at", models.DateTimeField(auto_now=True)),
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="evaluations.comprehensiveevaluation",
                        verbose_name="평가 정보",
                    ),
                ),
            ],
