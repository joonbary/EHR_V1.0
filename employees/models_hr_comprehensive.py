...
class BaseSalary(models.Model):
    """기본급 테이블"""
    employee = models.ForeignKey('Employee', on_delete=models.CASCADE, related_name='base_salaries')
...
class PromotionHistory(models.Model):
    """승진 이력 테이블"""
    employee = models.ForeignKey('Employee', on_delete=models.CASCADE, related_name='promotion_histories')
